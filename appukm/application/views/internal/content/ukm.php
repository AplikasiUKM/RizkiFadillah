                        ...
                        <div class="panel-body">
                            ...
                            ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><a href="<?php echo base_url();?>admin/ukm/edit/<?php echo $row->ukm_id; ?>"class="btn btn-lg btn-info btn-xs">Edit</a> <a href="<?php echo base_url();?>admin/ukm/hapus/<?php echo $row->ukm_id; ?>"class="btn btn-lg btn-danger btn-xs">Hapus</a></td>
                                    </tr>
                              <?php } ?>
                                </tbody>
                            </table>
                    ...
                    <!-- ========== End Flashdata ========== -->
                                    <form role="form" action="<?php echo base_url();?>admin/ukm/tambah" method="post" enctype="multipart/form-data" data-parsley-validate="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" value=""  name="ukm_desk" id="ukm_desk" required="" rows="3"></textarea>
                                        </div>
                                        <div class="form-group">
                ...
                <div class="col-lg-12">
                    ...
                    <!-- ========== End Flashdata ========== -->
                                    <form role="form" action="<?php echo base_url();?>admin/ukm/edit" method="post" enctype="multipart/form-data" data-parsley-validate="">
                                        ...
                                        <div class="form-group">
                                            <label>Deskripsi <span class="required">*</span></label>
                                            <textarea name="ukm_desk" value="<?php echo $ukm_desk;?>" id="ukm_desk" required="" class="form-control"><?php echo $ukm_desk;?></textarea>
                                        </div>
                                        <div class="form-group">
                                			<input type="submit" class="btn btn-primary" name="simpan" value="Simpan">
								</div>
