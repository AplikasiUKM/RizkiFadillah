        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <h2 class="panel-title"><center><img src="<?php echo base_url();?>assets/images/poltekpos.png" width="25">  ADMIN UKM POLTEKPOS</center></h2>
                    </div>
                ...
                <i class="fa fa-warning sign"></i><?php echo $this->session->flashdata('error'); ?>
                    ...
                    <?php } ?>
                    <!-- ========== End Flashdata ========== -->
                        <form role="form" action="<?php echo base_url();?>internal/ceklogin" method="post">
                            <fieldset>
